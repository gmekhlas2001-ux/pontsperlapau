/**
 * Reports / Transactions page.
 *
 * Shows a filterable table of inter-branch fund transfers with KPI cards at the
 * top (total count, completed, pending, total volume). Clicking a row opens the
 * TransactionDetailDialog where status can be updated. New transactions are
 * created via the NewTransactionDialog.
 *
 * Stats and the full transaction list are re-fetched together whenever a
 * filter changes or a transaction is created/updated, to keep the KPI cards
 * in sync.
 */
